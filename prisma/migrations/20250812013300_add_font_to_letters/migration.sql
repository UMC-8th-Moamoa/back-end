...
CREATE TABLE `wishlists` (
    ...
    `insertType` ENUM('URL', 'IMAGE') NOT NULL DEFAULT 'URL',
...
-- AddForeignKey
ALTER TABLE `letters` ADD CONSTRAINT `letters_fontId_fkey` FOREIGN KEY (`fontId`) REFERENCES `user_items`(`id`) ON DELETE SET NULL ON UPDATE CASCADE;
